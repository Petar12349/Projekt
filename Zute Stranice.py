...
master.geometry('850x850+0+0')
master.configure(background='#CCCC00')
naslov = Label(master, text="Zute stranice", font=("arial",30,"bold"), fg="white", bg="Black", relief="raised", bd="7").place(x=280, y=30)
...
L4 = Label(master, text = "Ulica", font=("arial",18) ,bg="#FFFF00", bd="1").place(x=450,y=250)
L5 = Label(master, text = "Zupanija", font=("arial",18) ,bg="#FFFF00", bd="1").place(x=450,y=300)
L6 = Label(master, text="Dodavanje u Registar:", font=("arial", 20), bg="#FFFF00", bd="5").place(x=265,y=160)
...
ime.place(x=200,y=250)

prezime= Entry(master, bd="6")
prezime.place(x=200,y=300)

mjesto= Entry(master, bd="6")
mjesto.place(x=200,y=350)

ulica= Entry(master, bd="6")
ulica.place(x=650,y=250)

zupanija= Entry(master, bd="6")
zupanija.place(x=650,y=300)

frame = Frame(master)
frame.place(x= 10, y = 470)           
Lb = Listbox(frame, height = 15, width = 126,font=("arial", 8)) 
...
def pretraga():
        ...
        if c.fetchone():
            L7 = Label(master, text="Pronadjeni korisnici", fg="blue", bd="5", width="17").place(x=660, y=710)
        else:
            L7 = Label(master, text="Nema odgovarajucih korisnika", fg="red", bd="5").place(x=10, y=710)  
